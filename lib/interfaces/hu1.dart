    ...
    return Scaffold(
      ...
      body: Center(
        child: buildMainContainer(740, 625, EdgeInsets.symmetric(vertical: 20.0, horizontal: 40.0), 
          buildCustomList(items: tasks, title: "Lista de tareas", addButton: true, nextPage: hu8.TaskRegistrationPage(), context: context, circle: false, fit: BoxFit.contain, buildChildren: (context, item, index) { 
            return [
              IconButton(
