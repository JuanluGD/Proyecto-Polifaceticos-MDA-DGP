...
*/
Future<bool> insertTask(String name, String description, String pictogram, String image) async {
  return await ColegioDatabase.instance.insertTask(name, description, pictogram, image);
}
...
Future<bool> modifyCompleteTask(int id, String name, String description, String pictogram, String image) async {
  return await ColegioDatabase.instance.modifyCompleteTask(id, name, description, pictogram, image);
}
