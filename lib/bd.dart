...
class ColegioDatabase{
    ...
    */
	...
	/*
        Método
        @Nombre --> getDecryptByStudent
        @Funcion --> Devuelve las imágenes que usa un alumno para iniciar sesión
        @Argumentos
            - user: el usuario del alumno del que se obtendran las imágenes
    */
